...
// import TemplateTypeStep from "./components/steps/TemplateTypeStep";
...
import TemplateTypeStep from "./components/steps/TemplateTypeStep";
import TemplateDetailStep from "./components/steps/TemplateDetailStep";
import TemplatePreview from "./components/steps/TemplatePreview";
import SavedTemplatesPage from "./components/steps/SavedTemplatesPage"; 
import SavedTemplateDetailPage from "./components/steps/SavedTemplateDetailPage";
...
function Step1() {
  ...
  return (
    <TemplateTypeStep
      onNext={(t) => {
        if (t === "safety") navigate(`/builder?type=${t}`);
      }}
...
function Step2() {
  ...
  const type = (sp.get("type") || "safety") as any;
  return (
    <TemplateDetailStep
      type={type}
      onBack={() => navigate(-1)}
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/builder" element={<Step2 />} />
        <Route path="/preview" element={<TemplatePreview />} />
        <Route path="/saved" element={<SavedTemplatesPage />} />
        <Route path="/saved/:id" element={<SavedTemplateDetailPage />} />
      </Routes>
    </BrowserRouter>
  );
}
